...
| It works on another model family / on non-quality rubrics / against other systems' readouts / from hidden states. | PENDING (all four) | entries 20, 22, 24 | Registered with expectations that can fail. |
